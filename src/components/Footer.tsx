      ...
      <div className="section-container py-16">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            <img src={logo} alt="ProcIvor" className="h-8 mb-4" />
            <p className="text-primary-foreground/70 max-w-md mb-6">
              Ivalua projects. Architect-led. Enterprise-grade 
              Source-to-Pay implementations.
            </p>
            <a
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-primary-foreground/60">
              <li><a href="#why-procivor" className="hover:text-accent transition-colors">Why ProcIvor</a></li>
        ...
        <div className="mt-16 pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-primary-foreground/50">
            © {new Date().getFullYear()} ProcIvor. All rights reserved.
          </p>
          <p className="text-sm text-primary-foreground/50">
